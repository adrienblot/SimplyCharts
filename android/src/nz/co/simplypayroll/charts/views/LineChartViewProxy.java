...
import nz.co.simplypayroll.charts.data.LineDataProxy;
...
public class LineChartViewProxy extends TiViewProxy 
{
	// Standard Debugging variables
	private static final String LCAT = "TiChartsModule";

	public LineChartViewProxy() {
		super();
	...
	public LineChartView getChartView() {
		return (LineChartView) getOrCreateView();
	}
					...
					public boolean handleMessage(Message msg) {
						switch (msg.what) {
							case MSG_SET_COLOR: {
								...
								LineChartView demoView = (LineChartView)view;
	...
	public void setData(final LineDataProxy dataProxy) {
		Log.d(LCAT,"[VIEWPROXY LIFECYCLE EVENT] Property Set: setColor");
					...
					public boolean handleMessage(Message msg) {
						switch (msg.what) {
							case MSG_SET_DATA: {
								...
								chartView.setData((LineData)dataProxy.data);
								result.setResult(null);
								return true;
							}
						}
	...
	public Object getAxisLeft() {
		...
		LineChartView chartView = getChartView(); 
		if(chartView != null) {
			axis = new YAxisProxy();
