...
function addLibrary(builder, cli, xobjs) {
	...
	var frameworkPaths = [
		'../../modules/iphone/nz.co.simplypayroll.charts/' + module.version + '/platform/Charts.framework'
		// add more if needed
	];

	require('wrench').rmdirSyncRecursive("modules/iphone/nz.co.simplypayroll.charts/" + module.version + "/platform/Charts.framework", true);

	if (cli.argv["$platform"] === "iphone" && (cli.argv["target"] === "dist-adhoc" || cli.argv["target"] === "dist-appstore")) {
		require('wrench').copyDirSyncRecursive("modules/iphone/nz.co.simplypayroll.charts/" + module.version + "/platform/appstore/Charts.framework", "modules/iphone/nz.co.simplypayroll.charts/" + module.version + "/platform/Charts.framework");
	} else {
		require('wrench').copyDirSyncRecursive("modules/iphone/nz.co.simplypayroll.charts/" + module.version + "/platform/sim/Charts.framework", "modules/iphone/nz.co.simplypayroll.charts/" + module.version + "/platform/Charts.framework");
	}
